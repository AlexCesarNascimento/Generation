...
@RestController
@CrossOrigin(origins = "*", allowedHeaders = "*") //headers são todos os cabeçarios 
...
public class CategoriaController {
	...
	@PostMapping
	public ResponseEntity<Categoria> post (@RequestBody Categoria descricao){ //pede a descriçao pelo corpo ao invez do link
